    ...
    <div>
        <div class="py-4 my-5 px-3 shadow" style="border-radius: 0.8rem;">
            ...
            <div class="row mx-5 my-2">
                ...
                <div class="col-md-12 px-2 py-2">
                    <select name="category" class="form-control" placeholder="">
                        ...
                        @foreach ($categories as $cat)
                            <option value="{{ $cat->id }}" {{ old('category', $parent->category_id) == $cat->id ? 'selected' : '' }}>{{ $cat->name }}</option>
                        @endforeach
                    </select>
                </div>
                {{-- <div class="col-md-12 px-2 py-2">
                ...
                <div class="col-md-12 px-2 py-2">
                    <textarea name="description" class="form-control" rows="4">{{ old('description', $parent->description) }}</textarea>
                </div>
                ...
                <div class="col-md-6 px-2 py-2">
                    <input type="url" name="website" class="form-control" value="{{ old('website', $parent->website) }}" placeholder="Business website">
                </div>
            </div>
        </div>
