            ...
            @switch($_step)
                @case(1)
                    ...
                    <div class="py-1 my-5 py-5 px-5 border bg-white" style="border-radius: 1rem;">
                        ...
                        <input  data-max-words="6" data-announce="true" class="my-2 form-control rounded" name="name" type="text" required value="{{ old('name', $product->name) }}" placeholder="Service Name">
