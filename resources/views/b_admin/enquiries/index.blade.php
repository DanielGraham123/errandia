                ...
                <tbody>
                    ...
                    @foreach(count($enquiries) > 0 ? $enquiries : collect([null, null, null, null, null, null, null, null, null, null, null]) as $enq)
                        <tr class="shadow-sm border-bottom bg-white">
                            ...
                            <td>
                                <div class="btn-group">
                                    <a href="{{ route('business_admin.enquiries.show', $enq->slug??'slug') }}" class="text-decoration-none button-tertiary mb-2"> <img src="{{ asset('assets/admin/icons/icon-edit.svg') }}" style="height: 1.1rem;"> view details</a> <br>
                                    <a href="{{ route('business_admin.enquiries.mail', $enq->slug??'slug') }}" class="text-decoration-none button-tertiary mb-2"> <img src="{{ asset('assets/admin/icons/icon-edit.svg') }}" style="height: 1.1rem;"> send email</a> <br>
                                    <a href="#" onclick="_prompt(`{{ route('business_admin.enquiries.delete', $enq->slug??'slug') }}`, 'Are you sure you intend to delete this item? This process cannot be undone.')" class="text-decoration-none button-tertiary"> <img src="{{ asset('assets/admin/icons/icon-trash.svg') }}" style="height: 1.1rem;"> Delete</a>
                                </div>
                            </td>
