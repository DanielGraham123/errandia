                            ...
                            <div class="right-box-contain">
                                @if($item->shop->user_id == auth()->id())
                                    <div class="d-flex justify-content-end pt-2">
                                        <a href="{{ route('business_admin.products.edit', $item->slug) }}" type="button" role="tab" class="nav-link button-tertiary" aria-selected="false"><span class="fa fa-edit"></span> Edit item</a>
                                    </div>
                                @endif
