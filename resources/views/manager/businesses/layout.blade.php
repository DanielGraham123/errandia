    ...
    <div id="navbar2" class="border-bottom container-fluid pt-4 d-flex justify-content-center ace-save-state no-scrollbar" style="background: {{$bg1}}; overflow-x: scroll">
        <div class="container py-0 my-0 d-flex mx-auto navbar-nav text-nowrap">
            <div class="nav-item border border-bottom-0 px-3 py-1">
                <a class="nav-link" title="Add New" href="{{ route('managers.home') }}">
             ...
             <div class="nav-item border border-bottom-0 px-3 py-1">
                <a class="nav-link" title="Add New" href="{{ route('managers.businesses.index') }}">
                    <small class="text-link"> 
            ...
            <div class="nav-item border border-bottom-0 px-3 py-1">
                <a class="nav-link" title="Add New" href="{{route('managers.errands.index')}}">
                    <small class="text-link"> 
            ...
            <div class="nav-item border border-bottom-0 px-3 py-1">
                <a class="nav-link" title="Add New" href="{{route('managers.products.index')}}">
                    <small class="text-link"> 
            ...
            <div class="nav-item border border-bottom-0 px-3 py-1">
                <a class="nav-link" title="Add New" href="{{ route('managers.services.index') }}">
                    <small class="text-link"> 
            ...
            <div class="nav-item border border-bottom-0 px-3 py-1">
                <a class="nav-link" title="Add New" href="{{ route('managers.enquiries.index') }}">
                    <small class="text-link"> 
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 col-lg-2 bg-white px-0 border-left border-right">
                            <ul class="menu nav my-5 d-sm-flex d-md-block mx-0 px-0">
                                <li class="nav-item d-sm-inlineblock d-md-block border-bottom"><a class="nav-link" href="{{ route('managers.businesses.index') }}">Manage Businesses</a></li>
                                <li class="nav-item d-sm-inlineblock d-md-block border-bottom"><a class="nav-link" href="{{ route('managers.managers.index') }}">Shop Managers</a></li>
                            </ul>
                        </div>
