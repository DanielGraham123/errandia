...
@section('section')
    ...
    <div class="py-2 container">
        <div class="d-flex justify-content-between py-3 my-2 px-2">
            ...
            <span>@if(isset($shop))<a class="button-primary" href="{{ route('manager.services.create', $shop->slug) }}"><img src="{{ asset('assets/admin/icons/icon-add.svg') }}" style="height: 1.4rem; width: 1.4rem; margin-right: 0.3rem;">Add Service</a>@endif</span>
