...
@section('section')
    <div class="py-2 container">
        <div class="d-flex justify-content-between py-3 my-2 px-2">
            ...
            <span>@if(isset($shop))<a class="button-primary" href="{{ route('manager.products.create', $shop->slug) }}"><img src="{{ asset('assets/admin/icons/icon-add.svg') }}" style="height: 1.4rem; width: 1.4rem; margin-right: 0.3rem;">Add Product</a>@endif</span>
                ...
                <tbody>
                    ...
                    @foreach(count($products) > 0 ? $products : collect([null, null, null, null, null, null]) as $prod)
                        <tr class="shadow-sm border-bottom bg-white">
                            ...
                            <td>
                                <div class="btn-group">
                                    <a href="{{ route('manager.enquiries.show', $prod->slug??'slug') }}" class="text-decoration-none mb-2"> <img src="{{ asset('assets/admin/icons/icon-edit.svg') }}" style="height: 1.1rem;"> edit</a> <br>
                                    <a href="{{ route('manager.enquiries.show', $prod->slug??'slug') }}" class="text-decoration-none mb-2"> <img src="{{ asset('assets/badmin/icon-view.svg') }}" style="height: 1.1rem;"> view details</a> <br>
                                    <a href="{{ route('manager.enquiries.mail', $prod->slug??'slug') }}" class="text-decoration-none mb-2"> <img src="{{ asset('assets/badmin/icon-edit-photo.svg') }}" style="height: 1.1rem;"> edit photo</a> <br>
                                    <a href="{{ route('manager.enquiries.mail', $prod->slug??'slug') }}" class="text-decoration-none mb-2"> <img src="{{ asset('assets/badmin/icon-unpublish.svg') }}" style="height: 1.1rem;"> unpublish</a> <br>
                                    <a href="#" onclick="_prompt(`{{ route('manager.enquiries.delete', $prod->slug??'slug') }}`, 'Are you sure you intend to delete this item? This process cannot be undone.')" class="text-decoration-none mb-2"> <img src="{{ asset('assets/admin/icons/icon-trash.svg') }}" style="height: 1.1rem;"> Delete</a>
                                </div>
                            </td>
